...
args.add_argument('--dataset', default='Felix_Full_64',
                  choices=['BBBC', 'MNIST', '2dSprite', 'Felix_FC', 'Felix_Channelwise'])
args.add_argument('--in', dest="input_path", default='/home/sachahai/Documents/VAE_manifold/DataSets/')
args.add_argument('--out', dest="output_path", default='/mnt/Linux_Storage/outputs/1_Felix')
...
dataset_lookUp = {
    ...
    "Felix_Full_128": {"path": 'Felix_Full_64', "meta": 'MetaData_FC_Felix_GT_link_CP.csv', 'feat': None},
