...
from models.networks_refactoring import betaVAE, VaDE, EnhancedVAE, twoStageVaDE, twoStageInfoMaxVAE, twoStageBetaVAE, \
    infoMaxVAE
...
args.add_argument('--model', default='pretrainDsprite_VAE')
...
### pretrain
# if args.train: pretrain_vaDE_model_SSIM(model, train_loader, pre_epoch=10, save_path=save_model_path, device=device)
# pretrain_EnhancedVAE_model_SSIM(model, train_loader, pre_epoch=15, save_path=save_model_path, device=device)
# if args.train: pretrain_2stageVaDE_model_SSIM(model, train_loader, pre_epoch=60, save_path=save_model_path, device=device)
# if args.train: pretrain_2stageVAEmodel_SSIM(model, train_loader, pre_epoch=60, save_path=save_model_path, device=device)
