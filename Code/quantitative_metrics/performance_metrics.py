...
def compute_perf_metrics(data_source, params_preferences):
    ...
    if params_preferences['save_unsupervised_metric'] != False:
        ...
        print('#######################################')
        _, _, _, _ = unsup_metric_and_local_Q(MetaData_df,
    ...
    if params_preferences['save_mine_metric'] != False:
        ...
        print('#######################################')
        MI_score_high = compute_MI(MetaData_df, low_dim_names=params_preferences['high_dim_names'],
        ...
        MI_score_df_high = pd.DataFrame({'MI_score': MI_score_high}, index=[0])
        if save_path != None:
            MI_score_df.to_csv(f'{save_path}/MI_score.csv')
            MI_score_df_high.to_csv(f'{save_path}/MI_score_high.csv')
    ...
    #         _, test_accuracies_m1_high, _ = classifier_performance(MetaData_df,
    #                                                                low_dim_names=params_preferences['high_dim_names'],
    ...
    #                                                           num_iteration=params_preferences['num_iteration'])
    #         _, test_accuracies_m2_high, _ = classifier_performance(MetaData_df,
    #                                                                low_dim_names=params_preferences['high_dim_names'],
    #                                                                Metrics=[False, True, False],
    #                                                                num_iteration=params_preferences['num_iteration'])
    #         print('Metric 3...')
    ...
    #                                                           num_iteration=params_preferences['num_iteration'])
    #         _, test_accuracies_m3_high, _ = classifier_performance(MetaData_df,
    #                                                                low_dim_names=params_preferences['high_dim_names'],
    #                                                                Metrics=[False, False, True],
    #                                                                num_iteration=params_preferences['num_iteration'])
    ...
    #
    #         mean_acc_m1_high = np.mean(test_accuracies_m1_high)
    #         std_acc_m1_high = np.std(test_accuracies_m1_high)
    #         mean_acc_m2_high = np.mean(test_accuracies_m2_high)
    #         std_acc_m2_high = np.std(test_accuracies_m2_high)
    #         mean_acc_m3_high = np.mean(test_accuracies_m3_high)
    #         std_acc_m3_high = np.std(test_accuracies_m3_high)
    #
    ...
    #              'test_accuracies_m1_high': test_accuracies_m1_high, 'test_accuracies_m2_high': test_accuracies_m2_high,
    #              'test_accuracies_m3_high': test_accuracies_m3_high, 'mean_acc_m1_high': mean_acc_m1_high,
    #              'std_acc_m1_high': std_acc_m1_high, 'mean_acc_m2_high': mean_acc_m2_high,
    #              'std_acc_m2_high': std_acc_m2_high, 'mean_acc_m3_high': mean_acc_m3_high,
    #              'std_acc_m3_high': std_acc_m3_high
    #              })
    #         if save_path != None:
    ...
    #         print(f'Accuracy High m1 : {mean_acc_m1_high}')
    #         print(f'Accuracy High m2 : {mean_acc_m2_high}')
    #         print(f'Accuracy High m3 : {mean_acc_m3_high}')
    #
    #     else:
    #
    #         print('Metric 1...')
