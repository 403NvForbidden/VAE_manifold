...
dataset_lookUp = {
    ...
    "new1": {"path": '4Channel_TIFs', # required field
             "meta": 'MetaData_NEW_GT_link_CP.csv',# required field
            'feat:': None,
            'GT': "GT_label" # matches class folder, required field, if no discrete classes,
            }
}
...
args.add_argument('--in', dest="data_path",
                  default='/home/sachahai/Documents/VAE_manifold/DataSets/')  # defines the directory where all the datasets are stored
args.add_argument('--out', dest="output_path",
                  default='/mnt/Linux_Storage/outputs/1_experiment')  # the output directory for resutls
