...
dataLoader = DataLoader(DSpritesDataset(imgs_sampled, GT_factors_sampled, Unique_index_sampled, feedback_csv='None'),
...
fig = px.scatter(df, x=low_dim_names[0], y=low_dim_names[1], text='Unique_id', color=label,
...
dataLoader = DataLoader(
    DSpritesDataset(imgs_sampled, GT_factors_sampled, Unique_index_sampled, feedback_csv=feedback_csv), batch_size=256,
    shuffle=True)
...
fig = px.scatter(df, x=low_dim_names[0], y=low_dim_names[1], text='Unique_id',
                 color_discrete_sequence=px.colors.qualitative.T10 + px.colors.qualitative.Alphabet)
